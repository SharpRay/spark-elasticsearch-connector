 ...
 */
class ElasticSqlParser(conf: SQLConf) extends ElasticAbstractSqlParser {
  val astBuilder = new ElasticSqlAstBuilder(conf)
 ...
 */
class ElasticSqlAstBuilder(conf: SQLConf) extends ElasticAstBuilder(conf) {
